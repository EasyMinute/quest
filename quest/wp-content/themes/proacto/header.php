		...
		<div class="container">
			...
			<div class="header__wrap">
				...
				<a href="<?php echo get_home_url() ?>" class="header_logo">
					<img src="<?php echo esc_url($header['logo']['url']) ?>" alt="<?php echo esc_attr($header['logo']['alt']) ?>">
				</a>
				...
				<div class="header__nav" id="header__nav">
					...
					<div class="header__buttons mobile">
						<p class="text-20"><?php echo __('Download the aplication', 'proacto') ?></p>
					...
					<?php wp_nav_menu( array(
	                    'menu'            => 'legal_menu',
	                    'container'       => 'nav',
	                    'container_class' => 'headermob_nav mobile',
	                    'menu_class'      => 'headermob_menu',
	                ) ); ?>
	                <ul class="headermob__socials mobile">
				...
				<button class="mobile burger" id="header__burger">
					<span></span>
					<span></span>
					<span></span>
				</button>
