<?php 
	...
	if ( ! function_exists( 'proacto_setup' ) ) :
		/**
		...
		function proacto_setup() {
			 ...
			 * If you're building a theme based on proacto, use a find and replace
			 * to change 'proacto' to the name of your theme in all the template files.
			 */
			...
			add_theme_support(
				'custom-background',
				apply_filters(
					'proacto_custom_background_args',
					array(
